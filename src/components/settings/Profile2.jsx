...
export const Profile2 = () => {
  return (
    <div className="w-[1280px] h-[1409px] mx-auto relative bg-gray-100">
  <div className="w-[1164px] h-[4012px] left-[116px] top-0 absolute bg-white" />
  <div className="w-[115px] h-[532px] left-0 top-0 absolute bg-gray-100" />
  <div className="w-[887px] h-[2000px] left-[393px] top-[122px] absolute bg-gray-100" />
...
Financial Services" />
  ...
  <input className="w-[269px] h-[50px] left-[944px] top-[1705px] absolute bg-gray-100 rounded-[30px]" />
  ...
  <div className="left-[970px] top-[1719px] absolute opacity-70 text-black text-sm font-normal font-['Poppins']">English (English)</div>
